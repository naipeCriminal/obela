<div class="container wmax">
  <div id="elastic-grid" class="row home text-center obela-bold productos">
    ...
    <div class="col-md-3 grid overeable">
      <a href="<?php bloginfo('url'); ?>/?p=117">
        ...
        <div class="grid-over full">
          <div class="table">
            <div class="cell-bottom">
              <p class="obelaizer">Pimientos</p>
              <p class="obelaizer">Rojos</p>
            </div>
          </div>
        </div>
      </a>
    ...
    <div class="col-md-3 grid">
      <div class="table">
        <div class="cell-center">
          <img src="<?php echo get_template_directory_uri(); ?>/assets/img/obela_smile.png" alt="">
        </div>
      </div>
    </div>
    <div class="col-md-3 grid overeable">
      <a href="<?php echo get_permalink(); ?>/?p=118">
        ...
        <div class="grid-over full">
          <div class="table">
            <div class="cell-bottom">
              <p class="obelaizer">Chiles</p>
              <p class="obelaizer">Toreados</p>
            </div>
          </div>
        </div>
      </a>
...
<script>
var colors = ["#8b0124", "#d7cd07", "#ffa000", "#817c00", "#ff6800", "#2d6d00", "#a2052c", "#ff6800"];
